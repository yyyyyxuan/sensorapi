...
export default function handler(req, res) {
  ...
  connection.connect((err) => {
    ...
    const query = 'SELECT * FROM ( SELECT DATE_ADD(time, INTERVAL 8 HOUR) AS converted_time, data, time, id FROM sensordata ORDER BY id DESC LIMIT 10 ) AS subquery ORDER BY id ASC;';
